...
<html>
    ...
    <body>
        <div class="primary">
            <div>
                <a href="Login.html" ><i class="fas fa-sign-in-alt"></i>로그인</a>
                <a href="" ><i class="fas fa-sign-out-alt"></i>로그아웃</a>
                <a href="jjim.html" ><i class="fas fa-heart" style="color: red;"></i>찜</a>
                <a href="Size.html" ><i class="fas fa-user-cog"></i>사이즈</a>
                <a href="jungbo.html" ><i class="fas fa-id-badge"></i>계정</a>
            </div>
        </div>
        <!-- 헤더영역 시작  -->
        <header class="header">
